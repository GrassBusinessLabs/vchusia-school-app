    ...
    <ion-header class="d-flex justify-center align-center header">
      ...
      <div class="d-flex justify-center">
        <v-chip-group mandatory
                      selected-class="text-checked"
                      >
          <v-chip class="filterItem" @click="userMessages(tag.en)" v-for="tag of filterTags" :key="tag.ua"> {{
              tag.ua
            }}
          </v-chip>
...
<!--      <p v-else class="mt-4 text-center">Немає пошарених завдань</p>-->
      ...
      <div class="feed-card" v-for="i of MessageStore.allMessages" @click="selectMessage(i)">
        <div class="user-info">
          <div class="avatar-card">
            ...
            <div class="comment-info">
              ...
              <div class="d-flex">
                <p class="data-send-comment">{{formatDate(i.createdDate)}}</p>
              </div>
            </div>
        ...
        <div class="comment-text-card">
          <div class="users-solution-card">
            <div class="deadline">
              ...
              <span class="deadline-date">{{ formatDate(i.deadline) }}</span>
            </div>
